...
//     const {phoneNum, phoneValue} = e.target;

//     setFormData({
//       ...formData, 
//       [name] : nameValue,
//       ...formData, [email] : emailValue,
//       ...formData, [phoneNum] : phoneValue
//     })
//   }
...
//         <div className='contact-form-name-container'>
//         <label>Full Name</label>
//         <input name="name" value={formData.name} onChange={handleChange}>{errors.name && <span>{errors.name}</span>}</input>
...
//         <div className='contact-form-phone-num-container'>
//         <label>Phone Number</label>
//         <input phoneNum="phoneNum" value={formData.phoneNum} onChange={handleChange}>{errors.phoneNum && <span>{errors.phoneNum}</span>}</input>
//         <img src={phoneImgContactForm}></img>
//         </div>
...
//         <input email="email" type="email" value={formData.email} onChange={handleChange}>{errors.email && <span>{errors.email}</span>}</input>
//         <p>Your Message</p>
