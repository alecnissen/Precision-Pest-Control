    ...
    <InsectCards></InsectCards>
        ...
        <div className="service-content-container">
          ...
          <ul>
            <li>
              ...
              inspections of all potential hiding spots to accurately assess the severity and spread of the infestation.
            </li>
            <li>
      ...
      <div className="service-container">
        ...
        <div className="service-content-container">
          ...
          <p>
            A cockroach service plan provides a thorough and strategic approach to eliminate cockroach infestations and
          ...
          <ul>
            <li>
              ...
              inspections to identify key infestation areas, entry points, and the severity of the problem.
            </li>
            <li>
              <span className="li-header-text">Strategic Treatments: </span>Utilizing a combination of baits,
              insecticides, and traps, the plan targets cockroaches at their source, aiming to disrupt their life cycles
      ...
      <div className="service-container">
        ...
        <div className="service-content-container">
          ...
          <p>
            A mosquito service plan offers a comprehensive solution to eliminate mosquito populations and prevent their
            return, ensuring a comfortable and safe environment. This plan includes thorough site inspections, targeted
          ...
          <ul>
            ...
            <li>
              <span className="li-header-text">Targeted Treatment Applications: </span>The plan employs a combination of
              larvicides, adulticides, and biological controls to effectively target mosquito populations at various
              life stages, ensuring thorough eradication.
            </li>
            <li>
        ...
        <div className="service-content-container">
          ...
          <ul>
            <li>
              ...
              detailed inspections to identify flea hotspots, potential entry points, and the extent of the infestation,
              ensuring a customized treatment plan.
            </li>
            <li>
              <span className="li-header-text">Specialized Treatment Methods: </span>The plan utilizes a combination of
              safe and effective treatments, including insect growth regulators (IGRs), insecticides, and environmental
              modifications to disrupt the flea lifecycle and eradicate the infestation.
            </li>
            <li>
      ...
      <div className="service-container">
        ...
        <div className="service-content-container">
          ...
          <p>
            A spider service plan provides a comprehensive approach to eliminate spider infestations and prevent future
            occurrences, ensuring a safe and comfortable living environment. This plan includes meticulous inspections,
          ...
          <ul>
            <li>
              ...
              inspections to locate spider nests, webs, and potential entry points, allowing for an accurate assessment
              of the infestation and the development of a tailored treatment plan.
            </li>
            <li>
              <span className="li-header-text">Specialized Treatments: </span> The plan includes the application of
              eco-friendly insecticides and strategic placement of traps to target spiders directly and eliminate their
              food sources, reducing spider populations effectively.
            </li>
            <li>
